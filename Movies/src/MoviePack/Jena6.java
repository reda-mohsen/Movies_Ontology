...
public class Jena6 {
    public static void main(String[] args) {
        ...
        try (
            ...
            boolean movieExists = qexec.execAsk();
            if (movieExists) {
                System.out.println("The movie 'Inception' exists in the ontology.");
            } else {
                System.out.println("The movie 'Inception' does not exist in the ontology.");
            }
        }
    }
